...
struct ImGuiTextFilter
{
    ...
    bool                IsActive(float delay = 0) const { return !Filters.empty(); }
...
inline c_color c_color::black(0, 0, 0, 255);
inline c_color c_color::white(255, 255, 255, 255);
inline c_color c_color::red(255, 0, 0, 255);
inline c_color c_color::green(0, 128, 0, 255);
inline c_color c_color::blue(0, 0, 255, 255);

inline c_color::c_color() {
    *reinterpret_cast<int*>(this) = 0;
}
inline c_color::c_color(const int _r, const int _g, const int _b) {
    set_color(_r, _g, _b, 255);
}
inline c_color::c_color(const int _r, const int _g, const int _b, const int _a) {
    set_color(_r, _g, _b, _a);
}
inline void c_color::set_raw_color(const int color32) {
    *reinterpret_cast<int*>(this) = color32;
}
inline int c_color::get_raw_color() const {
    return *(int*)this;
}

inline void c_color::set_alpha(const int alpha) {
    c_color_[3] = alpha;
}

inline void c_color::set_color(const int _r, const int _g, const int _b, const int _a) {
...
inline void c_color::set_color(float _r, float _g, float _b, float _a) {
...
inline void c_color::get_color(int& r, int& g, int& b, int& a) const {
    r = c_color_[0];
    g = c_color_[1];
    b = c_color_[2];
    a = c_color_[3];
}
inline bool c_color::operator== (const c_color& rhs) const {
    return *(int*)this == *(int*)&rhs;
}
inline bool c_color::operator!= (const c_color& rhs) const {
    return !operator==(rhs);
}
inline c_color& c_color::operator=(const c_color& rhs) {
    set_raw_color(rhs.get_raw_color());
    return *this;
}
inline ImU32 c_color::GetU32() {
	return ((c_color_[3] & 0xff) << 24) + ((c_color_[2] & 0xff) << 16) + ((c_color_[1] & 0xff) << 8) + (c_color_[0] & 0xff);
}